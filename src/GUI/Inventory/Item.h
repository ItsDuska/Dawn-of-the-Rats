...
public:
	Item(const std::string spriteName, const sf::IntRect itemArea, sf::FloatRect spriteSize, AssetManager& assetManager);
	std::string getName();
	Rarity getRarity();
	sf::Sprite getSprite();
	...
	void setTexture(const std::string spriteName, const sf::IntRect itemArea, sf::FloatRect spriteSize,AssetManager& assetManager);
