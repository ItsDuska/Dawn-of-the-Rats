...
class LoadWorld:
    __slots__ = "display_surface", "width","height","maxTiles","levelDirection","num","PASSABLE_BLOCKS","scale","ENEMIES","ORBS","enemy_group","orb_group","kärpäs_group","visible_sprites","active_sprites","collision_sprites"
    def __init__(self, level, width, height, maxTiles) -> None:
        ...
        self.scale = (int(self.width/self.maxTiles), int(self.height/self.maxTiles))
    ...
    def setup_level(self, tasoData):
        ...
        animated_objects = {401: [["Orb1.png", "Orb2.png", "Orb3.png", "Orb4.png", "Orb5.png", "Orb6.png", "Orb7.png", "Orb8.png", "Orb9.png", "Orb10.png"],
                                  ["JumpOrb"], 2], 402: [["Plant1.png", "Plant2.png", "Plant3.png", "Plant4.png", "Plant5.png", "Plant6.png", "Plant7.png", "Plant8.png", "Plant9.png", "Plant10.png"], ["Venus_Trap"]
                            ...
                            407: [["Dash1.png", "Dash2.png", "Dash3.png", "Dash4.png", "Dash5.png", "Dash6.png", "Dash7.png", "Dash8.png", "Dash9.png", "Dash10.png", "Dash11.png", "Dash12.png"],
                                  ["DashOrb"], 1], 408: [["Bord1.png", "Bord2.png", "Bord3.png", "Bord3.png", "Bord4.png", "Bord5.png", "Bord6.png", "Bord7.png", "Bord8.png"], ["Bord"]], 409: [["FallingRock1.png"], ["FallingRock"]],
                            410: [[f"Water_Waves{i}.png" for i in range(1,18)],["Water_Waves"]]
                            }
        """
                                # spriteSheet,    folder, frames, frame size
        animated_objects = {401: [["Kuvat","Palikat","Animoidut_Palikat","JumpOrb","JumpOrb.png"], 10, (16,16)], 
                            402: [["Kuvat","Palikat","Animoidut_Palikat","Venus_Trap","VenusTrap.png"],10,(16,16)], 
                            403: [["Kuvat","Palikat","Animoidut_Palikat","FishBoi","FishBoi.png"],3,(18,32)],
                            404: [["Kuvat","Palikat","Animoidut_Palikat","SlimeBoi","SlimeBoi.png"],3,(18,18)],
                            405: [["Snakee1.png", "Snakee2.png", "Snakee3.png", "Snakee4.png", "Snakee5.png", "Snakee6.png", "Snakee7.png", "Snakee8.png", "Snakee9.png", "Snakee9.png", ], ["Snake"]],
                            406: [["Kuvat","Palikat","Animoidut_Palikat","ZombiNPC","ZombiNpc.png"],4,(18,32)],
                            407: [["Kuvat","Palikat","Animoidut_Palikat","DashOrb","DashOrb.png"],12,(16,16)], 
                            408: [["Bord1.png", "Bord2.png", "Bord3.png", "Bord3.png", "Bord4.png", "Bord5.png", "Bord6.png", "Bord7.png", "Bord8.png"], ["Bord"]], 
                            409: [["FallingRock1.png"], ["FallingRock"]],
                            410: [["Kuvat","Palikat","Animoidut_Palikat","Water_Waves","WaterWaves.png"],17,(16,16)]
                            }
    ...
    def getAnimatedType(self, col, x, y, kuva):
        if col in self.ENEMIES:
            ...
            anim_obj = AnimatedObj(
                (x, y), kuva[col], self.display_surface, True, True, col,self.scale)
    ...
    def getOrbType(self,col, x, y, kuva):
        if col == 401:
            orb = JumpOrb((x, y), kuva[col], self.display_surface, True, True, col,self.scale)
        elif col == 407:
            orb = DashOrb((x, y), kuva[col], self.display_surface, True, True, col,self.scale)
