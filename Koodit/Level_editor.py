...
class Render:
    def __init__(self, maxRuudut, näyttö, taso):
        ...
        self.animated_objects = {401: [["Orb1.png"], ["JumpOrb"]], 402: [["Plant1.png"], ["Venus_Trap"]], 403: [["FishBoi1.png"], ["FishBoi"]], 404: [["SlimeBoi1.png"], ["SlimeBoi"]],
                                 405: [["Snakee1.png"], ["Snake"]], 406: [["ZombiNPC1.png"], ["ZombiNPC"]], 407: [["Dash1.png"], ["DashOrb"]], 408: [["Bord1.png"], ["Bord"]], 409: [["FallingRock1.png"], ["FallingRock"]],
