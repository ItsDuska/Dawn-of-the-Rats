...
class Enemy(pygame.sprite.Sprite):
    def __init__(self,pos,maxRuudut,animate,col,kuva,width,height,display_surface,groups) -> None:
        super().__init__()
    ...
    def Animoi(self,offset):
        ...
        if self.type in [103,105,106]:
            ...
            self.image = pygame.transform.scale(self.imageball,(int(self.width/self.maxRuudut),int(self.height/self.maxRuudut)+2))
